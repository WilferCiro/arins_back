...
describe("DependenciesController", () => {
  ...
  beforeEach(async () => {
    ...
    dependenciesController =
      module.get<DependencyController>(DependencyController);
  ...
  describe("createDependency", () => {
    it("should return the created dependency", async () => {
      ...
      jest
        .spyOn(dependenciesService, "create")
        .mockResolvedValue(createdDependency);
  ...
  describe("updateDependency", () => {
    it("should return the updated dependency", async () => {
      ...
      jest
        .spyOn(dependenciesService, "update")
        .mockResolvedValue(updatedDependency);

      // Act
      const result = await dependenciesController.update(
        dependencyId,
